...
*	编译环境：	VS2017 Professional + EasyX_20180727(beta)	*
...
void main()
{
	...
	// 设置窗口标题
	SetWindowText(GetHWnd(), L"Wish: 要一直活泼可爱的哦(#^_^#) -- 致小可爱");
	...
	mciSendString(L"play lucky repeat", 0, 0, 0);
	...
	while (!over || !kbhit())	//!kbhit()
	{
		...
		over = timeGetTime() - stover > 25000 ? true : false;
	}
...
void welcome()
{
	...
	for (int i = 0; i < 50; i++)
	{
		...
		outtextxy(x, y, L"Happy Valentine's Day");
		outtextxy(x - 130, y + 100, L"My Little Cut");
		Sleep(50);
	}
	//getchar();
	Sleep(3000);
	...
	{
		cleardevice();
		outtextxy(xi, 200, L"似曾相识 何曾相惜");
		Sleep(10);
	}
	//outtextxy(400, 200, L"似曾相识 何曾相惜");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		outtextxy(400, 200, L"似曾相识 何曾相惜");
		outtextxy(xi, 250, L"朝花夕誓 萌即正义");
		Sleep(10);
	}
	//outtextxy(400, 250, L"朝花夕誓 萌即正义");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		outtextxy(400, 200, L"似曾相识 何曾相惜");
		outtextxy(400, 250, L"朝花夕誓 萌即正义");
		outtextxy(xi, 300, L"无论遭遇过，或要遭遇什么");
		Sleep(10);
	}
	//outtextxy(400, 300, L"无论遭遇过，或要遭遇什么");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		...
		outtextxy(400, 250, L"朝花夕誓 萌即正义");
		outtextxy(400, 300, L"无论遭遇过，或要遭遇什么");
		outtextxy(xi, 350, L"不要忘记，你不是一个人");
		Sleep(10);
	}
	//outtextxy(400, 350, L"不要忘记，你不是一个人");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		...
		outtextxy(400, 300, L"无论遭遇过，或要遭遇什么");
		outtextxy(400, 350, L"不要忘记，你不是一个人");
		outtextxy(xi, 400, L"只要我在，不会让你孤独一人的存在");
		Sleep(10);
	}
	//outtextxy(400, 400, L"只要我在，不会让你孤独一人的存在");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		...
		outtextxy(400, 350, L"不要忘记，你不是一个人");
		outtextxy(400, 400, L"只要我在，不会让你孤独一人的存在");
		outtextxy(xi, 450, L"所有的曾经都是背景，衬托你到来时破晓的黎明");
		Sleep(10);
	}
	//outtextxy(400, 450, L"所有的曾经都是背景，衬托你到来时破晓的黎明");
	Sleep(1000);
	for (int xi = 0; xi <= 400; xi += 10)
	{
		cleardevice();
		...
		outtextxy(400, 400, L"只要我在，不会让你孤独一人的存在");
		outtextxy(400, 450, L"所有的曾经都是背景，衬托你到来时破晓的黎明");
		outtextxy(xi, 500, L"如流水般清洌，如焰火般灿烂");
		Sleep(10);
	}
	//outtextxy(400, 500, L"如流水般清洌，如焰火般灿烂");
	Sleep(1000);
	for (int xi = 0; xi <= 600; xi += 10)
	{
		...
		outtextxy(400, 450, L"所有的曾经都是背景，衬托你到来时破晓的黎明");
		outtextxy(400, 500, L"如流水般清洌，如焰火般灿烂");
		outtextxy(xi, 550, L"----小可爱 & 小田田");
		Sleep(10);
	}
	//outtextxy(600, 550, L"----小可爱 & 小田田");
